...
- **Protease** [P]  
  - <a href='#' onclick='easy_select("Sample Types", "Protease")'>Protease</a> / <a href='#' onclick='easy_select("Containers", "Protease Stock")'>Protease Stock</a>
  - <a href='#' onclick='easy_select("Sample Types", "Biotinylated Binding Target")'>Biotinylated Binding Target</a> / <a href='#' onclick='easy_select("Containers", "Biotinylated Binding Target Stock")'>Biotinylated Binding Target Stock</a>

- **Antibody** [Ab]  
  - <a href='#' onclick='easy_select("Sample Types", "Antibody")'>Antibody</a> / <a href='#' onclick='easy_select("Containers", "Antibody Stock")'>Antibody Stock</a>
...
- **Labeled Yeast Library** [YL]  
  - <a href='#' onclick='easy_select("Sample Types", "Yeast Strain")'>Yeast Strain</a> / <a href='#' onclick='easy_select("Containers", "Labeled Yeast Strain Suspension")'>Labeled Yeast Strain Suspension</a>
